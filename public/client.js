...
var App = React.createClass({displayName: "App",
  ...
  getInitialState: function() {
    ...
    this.streamTemplate.onValue(function(state)  {return initialState = state;});

    return initialState;
  },

  componentDidMount: function() {
    this.streamTemplate.onValue(function(state)  {return this.setState(state);}.bind(this));
  },
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "threes__app"}, 
        React.createElement(Board, {actions: actions, board: this.state.board}), 
        React.createElement("button", {ref: "restartBtn", onClick: this.restart}, "Restart")
      )
    );
  },
...
},{"./components/Board.jsx":181,"baconjs":1,"react/addons":4}],178:[function(require,module,exports){
/** @jsx React.DOM */
...
exports.create = function() {
  ...
  return { actions:actions, stores:stores };
};


},{"./actions/boardActions":179,"./stores/boardStore":182}],179:[function(require,module,exports){
var Bacon = require('baconjs');
...
},{"baconjs":1}],180:[function(require,module,exports){
var React = require('react');
...
},{"./App.jsx":177,"./Context.js":178,"react":176}],181:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
...
var Board = React.createClass({displayName: "Board",
  render: function() {
    ...
    var rows = board.map(function(row, rowIndex) 
      {return React.createElement("tr", {key: [rowIndex]}, 
        row.map(function(column, columnIndex) 
          {return React.createElement("td", {key: [rowIndex, columnIndex], "data-number": column.number}, 
            column.number
          );}
        )
      );}
    ...
    return (
      React.createElement("table", {className: "threes__board"}, rows)
    );
  }
});
...
var createTile = function(number)  {return Immutable.Map({
...
var createBoard = function () {
  ...
  var numberedTiles = emptyTiles
    .take(9)
    .map(function(tile, index)  {return tile.set('number', shuffledDeck[index]);})
    .toList();
  ...
  var row = function(row)  {return Immutable.Range(0, 4)
    .map(function(column)  {return tiles[column + (row * 4)];});};
...
},{"../util/shuffle":183,"baconjs":1,"immutable":3}],183:[function(require,module,exports){
